...
public class CellListPage extends InternalPage {
	...
	public CellListPage ensurePageLoaded() {
	    ...
	    wait.until(presenceOfElementLocated(By.cssSelector("td > textarea.gwt-TextArea")));
	    return this;
	 }	 	
	...
	//.................................................................
	public void clickCellListElementByIndex(int index) {
		
		String xpathFirstName = "//div/div[@__idx=" + Integer.toString(index) + "]/table//tr[1]/td[2]";
		driver.findElement(By.xpath(xpathFirstName)).click();
	}
